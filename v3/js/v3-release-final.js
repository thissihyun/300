...
.v10-home-stage{position:absolute;inset:0;overflow:hidden;background:#e9dfcd}.v10-home-slide{position:absolute;inset:0;opacity:0;transition:opacity .6s ease;overflow:hidden}.v10-home-slide.is-active{opacity:1}.v10-home-slide>img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;display:block}.v10-home-dots{position:absolute;left:50%;bottom:9px;transform:translateX(-50%);display:flex;gap:5px;z-index:3}.v10-home-dots i{width:6px;height:6px;border-radius:50%;background:rgba(255,255,255,.48);box-shadow:0 0 0 1px rgba(0,0,0,.15)}.v10-home-dots i.is-active{background:#fff}
