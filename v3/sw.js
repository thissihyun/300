...
const CACHE = 'days300-production-6';
const CORE = [
  './', './index.html', './css/v3.css', './css/v3-full.css', './css/v3-album.css', './css/v3-polish.css', './css/v3-production.css', './css/v3-userfix.css',
  ...
  '../v2/js/views/home.js','../v2/js/views/ourdays.js','../v2/js/views/diary.js','../v2/js/views/memory.js',
  '../v2/js/views/ourstory.js','../v2/js/views/album.js','../v2/js/views/special.js','../v2/js/views/future.js',
  '../v2/js/views/notifications.js','../v2/js/views/search.js'
];
